  ...
  <div class="player" v-show='playlist.length>0'>
        ...
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress-bar-wrapper">
              <progress-bar :precent='precent' @precentChange='onProgressBarChange'></progress-bar>
            </div>
    ...
    <transition name='mini'>
      <div class="mini-player" v-show='!fullScreen' @click='open'>
        <div class="icon">
          <img :src="currentSong.image" width="40" height="40" alt="" :class='cdClass'>
        </div>
        <div class="text">
...
export default {
  ...
  methods: {
    ...
    onProgressBarChange(precent) { // 进度条变化时
      const time = this.currentSong.duration * precent
